         ...
         (terpri)(princ "new context set:")(terpri)(princ *new-context*)
                (loop for match in (coerce *matches* 'list) do
                        ...
                        (terpri)(princ "sparql : ")(princ *match-sparql*)(terpri)(princ "the context is:")
                            ...
                            (let ((response-merge-match-srv (call-merge-srv *match-sparql* *new-context* t)))
...
(defun update-cube-list ()
    (cond 
       ((eq *cheat* t)
        (progn 
             (let ((cubes (onto::get-from "isAbove" "table_lack" "Cube")))
       ...
       ((setf *cubes* (onto::get-from "isAbove" "table_lack" "Cube"))))      
